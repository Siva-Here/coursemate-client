      ...
      <aside id="sidebar" className={isExpanded ? "expand" : ""}>
        <div className="d-flex menu-button" ref={menuButtonRef}>
          <button className="toggle-btn" type="button" onClick={toggleSidebar}>
            <BiSolidCategory className="fs-1 text-dark home-icon icons" />
            <h5 className="text-dark">Menu</h5>
          </button>
          <div className="sidebar-logo text-dark fw-bold">
            {username !== null ? (
              <div>
                <img
                  src={`${profile}`}
        ...
        >
          <li className="sidebar-item text-start ms-2 selected">
            <NavLink to="/home" className="sidebar-link">
              ...
              <span className="ms-3 fw-bold text-dark">Home</span>
            </NavLink>
          </li>
          <li className="sidebar-item mt-2 text-start ms-2">
            <NavLink to="/year" className="sidebar-link">
              ...
              <span className="ms-3 fw-bold text-dark">Year</span>
            </NavLink>
          </li>
          <li className="sidebar-item mt-2 text-start ms-2">
            <NavLink to="/domains" className="sidebar-link">
              <img src="/favicons/computer.png" height={"32px"} alt="" />
              <span className="ms-3 fw-bold text-dark">Domains</span>
            </NavLink>
          </li>
          ...
          <li className="sidebar-item mt-1 text-start ms-2">
            <NavLink to="/notifications" className="sidebar-link">
              ...
              <span className="ms-3 fw-bold text-dark">Notifications</span>
            </NavLink>
          </li>
          <li className="sidebar-item mt-1 text-start ms-2">
            <NavLink to="/team" className="sidebar-link">
              <img src="/favicons/coding.png" height={"32px"} alt="" />
              <span className="ms-3 fw-bold text-dark">Web Team</span>
            </NavLink>
          </li>
          {isAdmin ? (
            <li className="sidebar-item mt-2 text-start ms-2">
              <NavLink to="/admin" className="sidebar-link">
                ...
                <span className="ms-3 fw-bold text-dark">Admin Page</span>
              </NavLink>
            </li>
          ) : null}
          <li className="sidebar-item mt-2 text-start ms-2">
            ...
            >
              <NavLink to="/" onClick={handleLogOut}>
                <TbLogout2 className="fs-3 text-dark icons" />
